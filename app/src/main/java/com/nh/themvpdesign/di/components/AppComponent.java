...
import com.nh.themvpdesign.di.modules.RepositoryModule;
 ...
 */
@ApplicationScope
@Component(modules = {AppModule.class, RepositoryModule.class, AndroidInjectionModule.class, ActivityBuilder.class})
